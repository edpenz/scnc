...
public class VTextIcon implements Icon, PropertyChangeListener {
		...
		if (fRotation == ROTATE_NONE) {
			...
			for (int i = 0; i < fCharStrings.length; i++) {
				...
				case POSITION_TOP_RIGHT:
					tweak = fCharHeight / 3; // Should be 2, but they aren't
												// actually half-height
	...
	static final String sDrawsInTopRight = "\u3041\u3043\u3045\u3047\u3049\u3063\u3083\u3085\u3087\u308E"
			+ // hiragana
			"\u30A1\u30A3\u30A5\u30A7\u30A9\u30C3\u30E3\u30E5\u30E7\u30EE\u30F5\u30F6"; // katakana
	static final String sDrawsInFarTopRight = "\u3001\u3002"; // comma, full
																// stop
